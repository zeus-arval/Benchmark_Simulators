...
namespace Analyzer
{
    public class Programm
    {
        ...
        public static void Main(string[] args)
        {
            ...
            systemDataList.Add(new string[]{"--------------------",
                                            "CPU: 42.3",  
                                            "MEM: 2.5",
                                            "GPU-MEM: 1410MiB",
                                            "GPU-USG: 36%"});
            Dictionary<string, decimal[]> systemDataIntDict = new Dictionary<string, decimal[]>();
            systemDataIntDict.Add("CPU-USG", ReturnNumArray(systemDataList, 1));
            systemDataIntDict.Add("RAM-MEM-USG", ReturnNumArray(systemDataList, 2));
            systemDataIntDict.Add("GPU-USG", ReturnNumArray(systemDataList,4));
            systemDataIntDict.Add("GPU-MEM-USG", ReturnNumArray(systemDataList, 3));
        ...
        public static decimal[] ReturnNumArray(List<string[]> list, int row){
            ...
            for(int i = 0; i < lineNum; i++){
                ...
                numStr = numStr.Contains("MiB") ? numStr.Substring(0, numStr.Length - 4) : numStr;
